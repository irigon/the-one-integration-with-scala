...
for i, f in enumerate(file_list):
    ...
    # r_* = raw variable
    fname_variables = []
    r_name, r_router, r_buffer, r_ttl, r_msize, r_endtime, r_warmup, r_interval, _ = f.split('_')
    ...
    for var in [r_router, r_buffer, r_ttl, r_msize, r_endtime, r_warmup, r_interval]:
        k,v = var.split(':')
        d_out[k] = v
